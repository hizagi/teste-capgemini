  ...
  <div class="card">
    <div class="card-body">
      <div class="row">
        ...
        <h3 class="col-12">Inserir valor do saque</h3>
        <currency-input class="col-md-2 col-sm-3 ml-3" v-model="value" />
        <div class="col-md-3 col-sm-4">
          <button v-if="!loading" type="submit" class="btn btn-danger btn-block" v-on:click="withdraw()">Sacar</button>
  ...
  methods: {
    async withdraw() {
      ...
      try {
        ...
        await api.post(`accounts/${currentAccount.id}/withdraw`, {
          value: this.value,
        });
        ...
        this.loading = false;
        this.flash("Saque efetuado com sucesso", "success", { timeout: 10000 });
      } catch (error) {
